...
def test_enabled_collectors_have_unique_valid_metadata():
    ...
    assert collectors
    assert {item.key for item in collectors} == {"licor3b", "liquidos", "elmundodelvino", "comercialjp", "dondelanegra", "lamodelo", "socomep", "lavinoteca", "cav", "lakoka", "elbrindis", "ranchowines"}
